 ...
 */
    private void btnOrderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOrderActionPerformed
        ...
        try {
            //Finds the latest order and decrease the stock level by the last order quantity
            for(Map.Entry<Integer, OrderLine> olEntry :
                    loggedInCustomer.findLatestOrder().getOrderLines().entrySet())
            {
                Product orderedProduct = olEntry.getValue().getProduct();
        ...
        //Sets the latest order status to complete and goes to the confirmation screen
        loggedInCustomer.findLatestOrder().setStatus("Complete");
        db.completeOrder(orderId);
        JOptionPane.showMessageDialog(null,"Order Completed!");
        CustomerMainMenu ch = new CustomerMainMenu(loggedInCustomer);
        this.dispose();
        ch.setVisible(true);
